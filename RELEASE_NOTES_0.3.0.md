...
- Direct access to Apple's Passwords app for manual login retrieval.
...
- Safari Password AutoFill is unavailable for arbitrary third-party sites in the embedded browser. Use **More > Open Passwords...** or **Open in Safari**.
